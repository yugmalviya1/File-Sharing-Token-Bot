...
![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=FILE+SHARING+BOT!;CREATED+BY+YUG+MALVIYA!;A+ADVANCE+BOT+WITH+TOKEN+FEATURE+MUCH+MORE!)
</p>
...
* `START_MESSAGE` Optional: start message of bot, use HTML and <a href='https://github.com/YugMalviya/File-sharing-Token-Bot/blob/main/README.md#start_message'>fillings</a>
